...
<head>
    ...
    <link href="css/bootstrap.min.css" rel="stylesheet">
		...
		<link type="text/css" rel="stylesheet" href="css/bootstrap-material-design.css" media="screen,projection"/>
		<link type="text/css" rel="stylesheet" href="css/ripples.css"/>
...
?>
									...
									@else
										<li class="dropdown">
											...
											<ul class="dropdown-menu">
												<li><a href='/shop'> <span class="white-text text-darken-2">Trading</span></a></li>
												<li><a href='/shop'> <span class="white-text text-darken-2">Risk Management</span></a></li>
												<li><a href='/shop'> <span class="white-text text-darken-2">Fintech</span></a></li>
												<li><a href='/shop'> <span class="white-text text-darken-2">Project Management</span></a></li>
												<li><a href='/shop'> <span class="white-text text-darken-2">Finance</span></a></li>
												<li><a href='/shop'> <span class="white-text text-darken-2">Business Management</span></a></li>
												
												<li><a href='/shop'> <span class="white-text text-darken-2">Leadership</span></a></li>
												<li><a href='/shop'> <span class="white-text text-darken-2">Financial Market</span></a></li>
												
												<li><a href='/shop'> <span class="white-text text-darken-2">View All</span></a></li>
											</ul>
										</li>
									@endif
                         ...
                         <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ url('/fileentry') }}"><i class="material-icons">library_add</i>Manage Library</a></li>
																<li class="divider"></li>
																<li><a href="{{ url('um/tocreate') }}"><i class="material-icons">person_add</i>Create User</a></li>
																<li class="divider"></li>
    ...
    <script type="text/javascript" src="js/material.js"></script>
		...
		<script type="text/javascript" rel="stylesheet" href="js/ripples.css"/></script>
