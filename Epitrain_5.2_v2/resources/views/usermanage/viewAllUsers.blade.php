...
@if(Session::has('danger'))
    <div class="alert alert-danger">
        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
        <p style="font-size:18px">{{ Session::get('danger') }}</p>
    </div>
@endif
...
<div class="row">
    <div class="col-sm-6">
        <ul class="breadcrumb pull-left" style="margin-bottom: 5px;font-size:20px">
            ...
            <li style="font-size:16px" class="active">User Management</li>
        </ul>
    </div>
</div>
...
@if (Auth::user()->isAdmin)
    ...
    <div class="container">
                            ...
                            <table class="table table-bordered table-striped">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Courses To Add</th>
                                        </tr>
                                    </thead>   
                                    <tbody>
        ...
        <!-- deactivate users -->
        <div class="row">
            <h1>Search for users to deactivate</h1>
            <div class="col-md-4">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                         Search
                    ...
                    <div class="panel-body">
                        <div>       
                            <form action=<?php echo URL::route('findUsers');?> method="get" class="form-horizontal">
                                <div class="form-group">
                                    <label for="userInput" class="col-md-2 control-label">Name/<br><br>Email</label>

                                <div class="col-sm-10 col-xs-10">
                                    <input type="text" class="form-control" id="userInput" name="userInput" placeholder="User name or email">
                                </div>
                                <div class="form-group">
                                     <div class="col-sm-2 col-xs-2 col-xs-offset-2">
                                        <input type="submit" class="btn btn-raised" class="btn btn-raised btn-sm" style="background-color: #377BB5; color: #fff" value="Search">
            ...
            <div class="col-md-8">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                         List of users with specified name/email
                    </div>

                    <div class="panel-body">
                        @if(isset($shortlistedUsers))
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        @foreach($shortlistedUsers as $shortlistedUser)
                                        <tr>
                                         <td>
                                            <?php echo $shortlistedUser->email;?>
                                         </td>

                                         <td>
                                            <?php 
                                                if($shortlistedUser->isActive == 0) {
                                                    echo "Deactivated";
                                                } else {
                                                    echo "Activated";
                                                }
                                         ...
                                         <td>
                                             <form action=<?php echo URL::route('toggleActivation');?> method="post">
                                                <input type="hidden" name="userId" value=<?php echo $shortlistedUser->id;?> style="">

                                                @if($shortlistedUser->isActive == 0)
                                                    <input type="submit" class="btn btn-primary btn-raised btn-sm" value="Activate">
                                                @else
                                                    <input type="submit" class="btn btn-danger btn-raised btn-sm" value="Deactivate">
                                                @endif
           ...
           <tbody>
               <script>
                   ...
                   for(i=0; i<usersArray.length;i++){
                       ...
                       var status = i +"status";
                       if(usersArray[i].isActive == 0){
                           document.write("  <td style='color:black' id=" + isSubscribe+ ">Deactivated</td>");
                       }else{
                       document.write("  <td style='color:black'id=" + isSubscribe+ ">Activated</td>");
                       }
